...
class BaseOptions():
    ...
    def initialize(self):
        self._parser.add_argument('--data_dir', type=str, default='./datasets/Dataset-Crawler/', help='path to train data')
        ...
        self._parser.add_argument('--centers_filename', type=str, default='hms.pkl', help='pos hm files')
        ...
        self._parser.add_argument('--dataset_mode', type=str, default='object_center', help='chooses how datasets are loaded. [object_bb]')
